...
abstract AlphaColor(Int) from Int from UInt to Int to UInt {
    ...
    /**
     * RGB color component typed as `facile.Color`
     */
    public var color(get, set):Color;

    /**
     * RGB color component typed as `facile.Color` (alias of `color`)
     */
    ...
    /**
     * Create a new `AlphaColor` (ARGB) object from a `facile.Color` object and the given `alpha`
     * @param color RGB color object (`facile.Color`)
